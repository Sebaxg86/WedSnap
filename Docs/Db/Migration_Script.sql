-- WedSnap schema for Supabase SQL Editor
-- Run this script in Supabase SQL Editor.
-- Expected storage bucket: fotos-boda (private)
...
'Private photo records. Keep the fotos-boda storage bucket private and serve signed URLs only to admins or server-side functions.';

comment on table public.upload_batches is
'One upload batch per guest submission, including traceability fields captured from the client or edge layer.';
